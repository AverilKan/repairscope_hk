...
const T = {
  zh: {
    ...
    intro: [
      "使用修理易，即表示你同意以下使用條款。",
      "修理易現時正以香港創始試用形式測試服務。我哋希望幫物業業主及獲授權協助處理物業維修的人士整理維修資料、了解工程需要，並在合適的情況下協助尋找師傅及整理不同做法和報價。",
      "創始試用期間，修理易向物業業主提供的服務目前不收費。",
    ],
    whatWeDo: {
      heading: "修理易會做咩",
      bullets: [
      ...
      principle: "修理易協助整理成個過程，但本身唔會進行維修工程。",
    },
    submitting: {
      heading: "提交維修申請",
      p: [
        "提交維修申請只代表你希望修理易為你的個案進行初步檢視。",
        "提交申請並不代表修理易已接受個案，亦不保證我哋能夠找到合適師傅、取得報價或協助完成維修。",
    ...
    yourInfo: {
      ...
      p: [
        ...
        "修理易可能會就你提供嘅資料進一步查詢。整理好嘅維修簡報會俾你檢視，你亦可以要求更正。",
      ],
      privacyPrefix: "修理易點樣處理個人資料，會喺我哋嘅",
    ...
    quotations: {
      heading: "報價及工程比較",
      p: [
        "修理易可能會將師傅提供嘅資料整理成較清晰嘅格式，並且標示唔同建議做法或範圍之間嘅分別，等你比較嗰陣更加清楚。",
        "師傅提供嘅報價同技術講法，源頭係嗰位師傅本身。修理易將呢啲資料整理呈現，唔代表修理易本身成為承建商、測量師、工程師或者技術認證機構。",
    ...
    limitations: {
      ...
      bulletsIntro: "修理易唔保證：",
      careSkill: "修理易會以合理謹慎及技能提供我哋本身嘅服務。",
    },
    responsibility: {
      heading: "責任",
      p: [
        "修理易會以合理謹慎及技能提供我哋本身嘅服務。",
        "在法律容許的範圍內，修理易不會為獨立師傅實際進行的工程、師傅自行提供而我們無法合理核實的資料，或超出修理易合理控制範圍的延誤或供應情況負責。",
    ...
    emergencies: {
      ...
      p: [
        "修理易唔係緊急上門維修服務。",
        "如果人身安全或財產有即時危險，請喺適當情況下離開危險範圍，並聯絡相關緊急服務或大廈管理處，唔好等待修理易回覆。",
        "如有即時人身安全危險，可以撥打 999。",
      ],
    },
    pilot: {
      heading: "創始試用",
      p: [
        "呢個服務仍然處於測試階段。修理易可能會因應情況調整、暫停或者結束創始試用，亦可能改變我哋接受嘅維修個案類型。",
    ...
    fees: {
      heading: "費用",
      p: [
        "創始試用期間，修理易目前不向物業業主收取使用修理易服務的費用。",
        "如果將來收費模式有改變，我哋會在你需要支付任何費用之前清楚告知你。",
        "師傅就實際維修工程收取的費用並不是修理易的服務費。",
      ],
    },
    law: {
      heading: "適用法律",
  ...
  en: {
    ...
    back: "Back to home",
    intro: [
      "By using SimpleFix, you agree to these Terms of Use.",
      "SimpleFix is currently being tested as a founding-pilot service in Hong Kong. We help property owners and people authorised to manage a property repair organise repair information, understand the problem and, where appropriate, source contractors and structure different approaches and quotations.",
      "The SimpleFix service is currently free for property owners during the founding pilot.",
    ],
    whatWeDo: {
      heading: "What SimpleFix does",
      bullets: [
      ...
      principle: "SimpleFix helps organise the process. It does not itself carry out the repair.",
    },
    submitting: {
      heading: "Submitting a repair",
      p: [
        "Submitting a repair request asks SimpleFix to review the case.",
        "Submission does not mean that SimpleFix has accepted the repair and does not guarantee that we will find a suitable contractor, obtain quotations or manage the repair through to completion.",
    ...
    yourInfo: {
      ...
      p: [
        ...
        "SimpleFix may ask you for clarification. The generated repair brief is shown to you for review, and you can ask for it to be corrected.",
      ],
      privacyPrefix: "How SimpleFix handles personal data is explained in our",
    ...
    contractors: {
      ...
      p: [
        "SimpleFix does not itself perform the repair work.",
        "Where SimpleFix helps you contact a contractor, that contractor remains an independent service provider.",
    ...
    quotations: {
      ...
      p: [
        "SimpleFix may organise the information contractors provide into a clearer format, and highlight differences in proposed scope or approach so they are easier to compare.",
        "Quotations and technical statements come from the contractor who provides them. Organising this information does not make SimpleFix the builder, surveyor, engineer or technical certifier.",
    ...
    limitations: {
      ...
      bulletsIntro: "SimpleFix does not guarantee:",
      careSkill: "SimpleFix will provide its own service with reasonable care and skill.",
    },
    responsibility: {
      heading: "Responsibility",
      p: [
        "SimpleFix will provide its own service with reasonable care and skill.",
        "To the extent permitted by law, SimpleFix is not responsible for repair work actually performed by an independent contractor, information independently supplied by a contractor that SimpleFix could not reasonably verify, or delays and availability outside SimpleFix's reasonable control.",
    ...
    emergencies: {
      heading: "Emergencies",
      p: [
        "SimpleFix is not an emergency call-out service.",
        "If there is immediate danger to people or property, leave the danger area where appropriate and contact the relevant emergency service or building management — do not wait for SimpleFix to respond.",
    ...
    pilot: {
      ...
      p: [
        "This service is still being tested. SimpleFix may adjust, pause or end the founding pilot, and may change the types of repair cases it accepts.",
    ...
    fees: {
      heading: "Fees",
      p: [
        "SimpleFix currently does not charge property owners for using the SimpleFix service during the founding pilot.",
        "If this changes in future, we will tell you clearly before you are required to pay any SimpleFix fee.",
        "Charges made by a contractor for the actual repair work are not SimpleFix service fees.",
      ],
    },
    law: {
